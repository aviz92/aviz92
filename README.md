...
🚀 **Infrastructure Architect | Technical Leader | Python Expert** <br>
...
* **[internal-ai-agents-marketplace](https://github.com/aviz92/internal-ai-agents-marketplace)** – The internal catalog of skills, plugins, and rules powering the `agents-marketplace` CLI — curated AI-agent context authored once and rendered natively for Claude Code, Cursor, Copilot, Codex CLI, Gemini CLI, and more.
...
* **[ai-agents-marketplace](https://github.com/aviz92/ai-agents-marketplace)** – An interactive CLI (`agents-marketplace`) that distributes reusable AI-agent context — skills, plugins, and rules — into any project, rendering each artifact into the native format every supported AI coding agent expects.
